class PiecesController < ApplicationController
  ...
  def update
    ...
    elsif @piece.type == "King" && @piece.legal_to_castle?(piece_params[:x_position].to_i, piece_params[:y_position].to_i)
  ...
  def piece_params
    params.require(:piece).permit(:x_position, :y_position, :captured, :white, :id, :type)
  end
