...
RSpec.describe Piece, type: :model do
  ...
  describe "#update" do
    ...
    it "should update coordinates if successful move" do
      ...
      pawn.update{pawn.id, pawn.x_position = 1, pawn.y_position = 5}
    ...
    it "should switch player turns if successful move" do
     ...
     it "should return error if the piece's move path is obstructed" do
      ...
      bishop.update{bishop.id, bishop.x_position = 3, bishop.y_position = 4}
      expect(bishop.status).to eq 422
     end
    ...
    it "should return false if a pawn tries to capture opponent vertically" do
      ...
      pawn.update{pawn.id, pawn.x_position = 1, pawn.y_position = 6}
      expect(pawn.status).to eq 422
    end
    ...
    it "should return true if a pawn tries to capture opponent diagonally" do
      ...
      pawn.update{pawn.id, pawn.x_position = 3, pawn.y_position = 6}
      expect(pawn.status).to eq 200
      bishop.reload
      expect(bishop.x_position).to eq nil
    end
    ...
    it "should return status 201 if opponent king is in check and cannot move out of check" do
      ...
      rook.update{rook.id, rook.x_position = 1, rook.y_position = 7 }
    ...
    it "should return status 201 if opponent king is not in check but has no valide moves left (stalemate)" do
      ...
      white_queen.update{white_queen.id, white_queen.x_position = 7, white_queen.y_position = 3 }
    ...
    it "should return 422 if the king tries to move into check by vertical pawn capture" do
      ...
      white_king.update{white_king.id, white_king.x_position = 1, white_king.y_position = 5 }
    ...
    it "should return 201 if the queen checks king" do
      ...
      white_queen.update{white_queen.id, white_queen.x_position = 6, white_queen.y_position = 2 }
      expect(white_queen.status).to eq 201
    end
